...
Agreement at this level is not something a broken implementation produces by
accident. The two rules in Section~\ref{app:ladder} --- matching by price and
requiring observability in both snapshots --- are exactly what stands between
this and a number several times too large.
