...
Realized spread, 60s (bp)$^{\dagger}$ & -- &  & -- &  & 324 \\
Depth at best quote (log)$^{\dagger}$ & -- &  & -- &  & 324 \\
Realised variance (log)$^{\dagger}$ & -- &  & -- &  & 324 \\
Variance-ratio deviation$^{\dagger}$ & -- &  & -- &  & 324 \\
Amihud illiquidity (log)$^{\dagger}$ & -- &  & -- &  & 311 \\
\bottomrule
\end{tabular}
