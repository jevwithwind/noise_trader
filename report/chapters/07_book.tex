...
-0.0012, not statistically distinguishable from zero. Coefficients here are small by construction and
...
interaction term is 0.8634, not statistically distinguishable from zero. A positive value means
