...
benchmarks. Round prices take 14.54\% of all
continuous-session volume against his 13.5\%, and
13.44\% of buy-initiated large-trade volume against his 14.8\%. Under a
...
and while this sample holds too few 0.1-yen stock-days to report a separate mean, the 1-yen grid averages 14.49\%. The mechanism is not mysterious.
...
horizon the premium is nan basis points on the buy side and
nan on the sell side, against Ohta's 1.26 and 1.12.
...
side. 12.50\% of visible ten-level ask depth sits at round prices against a
...
\paragraph{Verdict.}
The sample reproduces the paper's facts: clustering well above the uniform benchmark, concentrated in large trades, without the usual size gradient, with the impact premium not positive here. The measurement is sound and the rest of the study can be built on it.
